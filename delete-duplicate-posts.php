	...
	class delete_duplicate_posts {
		...
		<div class="wrap">
			<div style="float:right;">
				<a href="https://cleverplugins.com" target="_blank"><img src='<?php echo plugin_dir_url(__FILE__); ?>cleverpluginslogo.png' height="54" width="300" alt="<?php _e('Visit cleverplugins.com','delete_duplicate_posts'); ?>"></a>
			</div>
			...
			<div id="dashboard">
				...
				if ($this->options['ddp_enabled'] ) {
					...
					?>
					<div class="statusdiv">
						<h3><?php _e('You have no duplicate posts.','delete_duplicate_posts');?></h3>
						<p>
							<?php
							$nextscheduled = wp_next_scheduled('ddp_cron');
